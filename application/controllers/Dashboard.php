...
class Dashboard extends Dashboard_Controller
{
    ...
    public function index()
    {
        ...
        if (is_student_loggedin() || is_parent_loggedin()) {
            ...
            $this->data['superadmin_total_collected'] = $this->dashboard_model->getTotalFeesCollected($schoolID);
            $this->data['superadmin_todays_fees'] = $this->dashboard_model->getTodaysFeesCollected($schoolID);
            $this->data['superadmin_pending_fees'] = $this->dashboard_model->getPendingFeesDues($schoolID);
