   ...
   public function checkout()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() !== false) {
                ...
                if ($payVia == 'cashfree') {
                    $url = base_url("subscription/cashfree");
                    $this->session->set_userdata("params", $params);
                }
    ...
    public function cashfree()
    {
        ...
        $params = $this->session->userdata('params');
        if (!empty($params)) {
            $params['student_id'] = get_loggedin_user_id();
            $params['student_email'] = $params['email'];
            $params['student_phone'] = $params['mobile_no'];
            $params['return_url'] = base_url("subscription/cashfree_verify?order_id={order_id}");
