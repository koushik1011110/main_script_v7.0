...
class Saas_model extends MY_Model
{
    ...
    public function getSchool($id)
    {
        ...
        $this->db->from('branch');
        $this->db->join('saas_subscriptions', 'saas_subscriptions.school_id = branch.id', 'left');
    ...
    public function getSectionsPaymentMethod()
    {
        ...
        $this->db->select('paypal_status,stripe_status,payumoney_status,paystack_status,razorpay_status,sslcommerz_status,jazzcash_status,midtrans_status,flutterwave_status,paytm_status,toyyibpay_status,payhere_status,cashfree_status')->from('payment_config');
        ...
        if ($status['cashfree_status'] == 1) {
            $payvia_list['cashfree'] = 'Cashfree';
        }
