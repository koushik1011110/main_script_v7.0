    ...
    <div class="contact-info-box">
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12 d-none d-md-block position-relative">
                <div class="box-img">
                    <img src="<?php echo base_url('uploads/frontend/images/' . $page_data['box_image']); ?>"
                        alt="Image" />
                </div>
            </div>
...
<!--Map Start-->
<div class="map">
    <iframe width="100%" height="350" id="gmap_canvas" src="<?php echo $page_data['map_iframe']; ?>" frameborder="0"
