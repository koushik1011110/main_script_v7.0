            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="list-inline-item"><i class="fas fa-phone-volume"></i>
                            <?php echo $cms_setting['mobile_no']; ?></li>
                        <?php
                        ...
                        if (!is_loggedin()) {
                            ...
                            <li class="list-inline-item"><a href="<?php echo $authenticationURL; ?>"><i
                                        class="fas fa-user-lock"></i> Login</a></li>
                        <?php } else { ?>
                            <li class="list-inline-item"><a href="<?php echo base_url('dashboard'); ?>"><i
                                    ...
                                    <?php if (!empty($row['submenu'])) { ?>
                                        <ul class="dropdown-menu" role="menu">
                                            <?php foreach ($row['submenu'] as $row2) {
                                                ...
                                                ?>
                                                <a class="dropdown-item<?php echo $active_menu; ?>" <?php echo $op_new_tab; ?>
                                                    href="<?php echo $row2['url']; ?>"><?php echo $row2['title']; ?></a>
                                            <?php } ?>
                                        </ul>
                                    <?php } ?>
                                </li>
                            ...
                            <li class="nav-item m-login">
                                ...
                                <?php } else { ?>
                                    <a href="<?php echo base_url('dashboard'); ?>"
                                        class="btn d-grid btn-black mt-sm">Dashboard</a>
                                <?php } ?>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="nav">
                        <?php foreach ($news_list as $key => $value) { ?>
                            <li><a class="text-white"
                                    href="<?php echo base_url($url_alias . '/news_view/' . $value->alias); ?>"><strong><?php echo str_pad($key + 1, 2, '0', STR_PAD_LEFT); ?>.</strong>
                                    <?php echo $value->title . " - <span class='date-text'>" . _d($value->date); ?></span></a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
