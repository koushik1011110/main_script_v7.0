<?php if (is_superadmin_loggedin()) { ?>
    <li
        ...
        <ul class="nav nav-children">
            ...
            <li
                class="<?php if ($sub_page == 'saas/pending_request' || $sub_page == 'saas/school_approved')
                    echo 'nav-active'; ?>">
            ...
            <li
                class="<?php if ($sub_page == 'saas/transactions' || $sub_page == 'saas/school_details')
                    echo 'nav-active'; ?>">
            ...
            <li
                class="<?php if ($sub_page == 'saas_offline_payments/type' || $sub_page == 'offline_payments/type_edit')
                    echo 'nav-active'; ?>">
                <a href="<?= base_url('saas_offline_payments/type') ?>">
                    <span><i class="fas fa-caret-right"
                            aria-hidden="true"></i><?= translate('offline_payments') . " " . translate('type') ?></span>
                </a>
            </li>
        </ul>
    </li>
