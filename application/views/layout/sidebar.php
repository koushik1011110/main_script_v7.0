<aside id="sidebar-left" class="sidebar-left">
    <style>
    html.sidebar-left-collapsed .sidebar-header .sidebar-title {
        opacity: 0 !important;
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <?php if (moduleIsEnabled('inventory')) {
                        if (
                            get_permission('product', 'is_view') ||
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'inventory' || $main_menu == 'inventory_report')
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    if (get_permission('product_category', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/category')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_store', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/store' || $sub_page == 'inventory/store_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_supplier', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/supplier' || $sub_page == 'inventory/supplier_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_unit', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/unit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_purchase', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/purchase' || $sub_page == 'inventory/purchase_edit' || $sub_page == 'inventory/purchase_bill')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_sales', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/sales' || $sub_page == 'inventory/sales_invoice')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('product_issue', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'inventory/issue')
                                            echo 'nav-active'; ?>">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'frontend')
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    if (get_permission('frontend_menu', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/menu' || $sub_page == 'frontend/menu_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('manage_page', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/content' || $sub_page == 'frontend/content_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_slider', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/slider' || $sub_page == 'frontend/slider_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_features', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/features' || $sub_page == 'frontend/features_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_testimonial', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/testimonial' || $sub_page == 'frontend/testimonial_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_services', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/services' || $sub_page == 'frontend/services_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_faq', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/faq' || $sub_page == 'frontend/faq_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_gallery_category', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/gallery_category')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_gallery', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/gallery' || $sub_page == 'frontend/gallery_edit' || $sub_page == 'frontend/gallery_album')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('frontend_news', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'frontend/news' || $sub_page == 'frontend/news_edit')
                                            echo 'nav-active'; ?>">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'reception')
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('enquiry', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception/enquiry' || $sub_page == 'reception/enquiry_edit' || $sub_page == 'reception/enquiry_details')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('postal_record', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception/postal' || $sub_page == 'reception/postal_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('call_log', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception/call_log' || $sub_page == 'reception/call_log_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('visitor_log', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception/visitor' || $sub_page == 'reception/visitor_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('complaint', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception/complaint' || $sub_page == 'reception/complaint_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('config_reception', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'reception_config/reference' || $sub_page == 'reception_config/response' || $sub_page == 'reception_config/calling_purpose' || $sub_page == 'reception_config/visiting_purpose' || $sub_page == 'reception_config/complaint_type')
                                            echo 'nav-active'; ?>">
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'admission')
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (get_permission('online_admission', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'online_admission/index' || $sub_page == 'online_admission/approved')
                                        echo 'nav-active'; ?>">
                                ...
                                if (moduleIsEnabled('multi_class')) {
                                    if (get_permission('multi_class', 'is_add')) { ?>
                                        ...
                                        <li class="<?php if ($sub_page == 'multiclass/index')
                                            echo 'nav-active'; ?>">
                                            <a href="<?= base_url('multiclass/index') ?>">
                                                <span><i class="fas fa-caret-right"
                                                        aria-hidden="true"></i><?= translate('multi_class') ?></span>
                                            </a>
                                        </li>
                                    <?php }
                                }
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'student')
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (get_permission('disable_reason', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'student/disable_reason')
                                        echo 'nav-active'; ?>">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'card_manage')
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('id_card_templete', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'card_manage/id_card_templete' || $sub_page == 'card_manage/id_card_templete_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('generate_student_idcard', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'card_manage/generate_student_idcard')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('generate_employee_idcard', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'card_manage/generate_employee_idcard')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('admit_card_templete', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'card_manage/admit_card_templete' || $sub_page == 'card_manage/admit_card_templete_edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('generate_admit_card', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'card_manage/generate_student_admitcard')
                                            echo 'nav-active'; ?>">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'certificate')
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('certificate_templete', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'certificate/index' || $sub_page == 'certificate/edit')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('generate_student_certificate', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'certificate/generate_student')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('generate_employee_certificate', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'certificate/generate_employee')
                                            echo 'nav-active'; ?>">
                        ...
                        <li class="nav-parent <?php if (
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php if (get_permission('teacher_timetable', 'is_view')) { ?>
                                    ...
                                    <li class="<?php if ($sub_page == 'timetable/teacherview')
                                        echo 'nav-active'; ?>">
                                ...
                                <?php if (get_permission('student_promotion', 'is_view')) { ?>
                                    <!-- student promotion -->
                                    <li class="<?php if ($sub_page == 'student_promotion/index')
                                        echo 'nav-active'; ?>">
                        ...
                        if (get_permission('live_class', 'is_view')) { ?>
                            <li class="nav-parent <?php if ($main_menu == 'live_class')
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <li class="<?php if ($sub_page == 'live_class/reports')
                                        echo 'nav-active'; ?>">
                    ...
                    if (
                        ...
                        ?>
                        <!-- exam master -->
                        <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'mark' || $main_menu == 'exam_timetable' || $main_menu == 'marksheet_template')
                            echo 'nav-expanded nav-active'; ?>">
                            <a>
                            ...
                            <ul class="nav nav-children">
                                ...
                                if (
                                    ...
                                    ?>
                                    <!-- exam -->
                                    <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'exam_term' || $main_menu == 'exam_hall' || $main_menu == 'marksheet_template')
                                        echo 'nav-expanded nav-active'; ?>">
                                        <a>
                                        ...
                                        <ul class="nav nav-children">
                                            ...
                                            if (get_permission('marksheet_template', 'is_view')) { ?>
                                                <li class="<?php if ($sub_page == 'marksheet_template/index')
                                                    echo 'nav-active'; ?>">
                                            ...
                                            <li class="nav-parent <?php if ($main_menu == 'transport')
                                                ...
                                                <ul class="nav nav-children">
                                                    ...
                                                    if (get_permission('transport_assign', 'is_view')) { ?>
                                                        <li class="<?php if ($sub_page == 'transport/vehicle_assign' || $sub_page == 'transport/vehicle_assign_edit')
                                                            echo 'nav-active'; ?>">
                                                    ...
                                                    if (get_permission('transport_fees_setup', 'is_view')) { ?>
                                                        <li class="<?php if ($sub_page == 'transport/fees_setup' || $sub_page == 'transport/fees_setup_edit')
                                                            echo 'nav-active'; ?>">
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('student_attendance', 'is_add')) {
                                        ...
                                        if ($getAttendanceType == 2 || $getAttendanceType == 1) { ?>
                                            <li class="<?php if ($sub_page == 'attendance_period/index')
                                                echo 'nav-active'; ?>">
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'sendsmsmail')
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('sendsmsmail', 'is_add')) { ?>
                                        ...
                                        <li class="<?php if ($sub_page == 'sendsmsmail/campaign_reports')
                                            ...
                                            <a href="<?= base_url('sendsmsmail/campaign_reports') ?>">
                                                <span><i class="fas fa-caret-right"></i>Sms / Email
                                    ...
                                    if (get_permission('student_birthday_wishes', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'birthday/student')
                                            echo 'nav-active'; ?>">
                                    ...
                                    if (get_permission('staff_birthday_wishes', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'birthday/staff')
                                            echo 'nav-active'; ?>">
                    ...
                    if (moduleIsEnabled('student_accounting')) {
                        if (
                            ...
                            ?>
                            <!-- student accounting -->
                            <li class="nav-parent <?php if ($main_menu == 'fees' || $main_menu == 'offline_payments')
                                echo 'nav-expanded nav-active'; ?>">
                                <a>
                                    <i
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    <?php if (get_permission('offline_payments', 'is_view') || get_permission('offline_payments_type', 'is_view')) { ?>
                                        <li class="nav-parent <?php if ($main_menu == 'offline_payments')
                                            echo 'nav-expanded nav-active'; ?>">
                                            <a>
                                            ...
                                            <ul class="nav nav-children">
                                                <?php if (get_permission('offline_payments_type', 'is_view')) { ?>
                                                    <li class="<?php if ($sub_page == 'offline_payments/type' || $sub_page == 'offline_payments/type_edit')
                                                        echo 'nav-active'; ?>">
                                                ...
                                                if (get_permission('offline_payments', 'is_view')) { ?>
                                                    <li class="<?php if ($sub_page == 'offline_payments/history')
                                                        echo 'nav-active'; ?>">
                    ...
                    if (
                        ...
                        <li class="nav-parent <?php if (
                            ...
                            <ul class="nav nav-children">
                                <?php if (get_permission('student', 'is_view')) { ?>
                                    <li class="nav-parent <?php if ($main_menu == 'student_repots')
                                        echo 'nav-expanded nav-active'; ?>">
                                        <a><i
                                                class="fas fa-print"></i><span><?php echo translate('student') . " " . translate('reports'); ?></span></a>
                                        <ul class="nav nav-children">
                                            <li class="<?php if ($sub_page == 'student/login_credential_reports')
                                                echo 'nav-active'; ?>">
                                                <a
                                                    href="<?= base_url('student/login_credential_reports') ?>"><?= translate('login_credential') ?></a>
                                            </li>
                                            <li class="<?php if ($sub_page == 'student/admission_reports')
                                                echo 'nav-active'; ?>">
                                                <a
                                                    href="<?= base_url('student/admission_reports') ?>"><?= translate('admission_report') ?></a>
                                            </li>
                                            <li class="<?php if ($sub_page == 'student/classsection_reports')
                                                echo 'nav-active'; ?>">
                                                <a
                                                    href="<?= base_url('student/classsection_reports') ?>"><?= translate('class_&_section_report') ?></a>
                                            </li>
                                            <li class="<?php if ($sub_page == 'student/sibling_report')
                                                echo 'nav-active'; ?>">
                                                <a
                                                    href="<?= base_url('student/sibling_report') ?>"><?= translate('sibling_report') ?></a>
                                            </li>
                                        </ul>
                                    </li>
                                <?php } ?>
                                            ...
                                            <ul class="nav nav-children">
                                                <?php if (get_permission('student_attendance_report', 'is_view')) {
                                                    if ($getAttendanceType == 2 || $getAttendanceType == 0) {
                                                        ...
                                                        <li class="<?php if ($sub_page == 'attendance/student_classreport')
                                                            echo 'nav-active'; ?>">
                                                            <a href="<?= base_url('attendance/student_classreport') ?>">
                                                                <?= translate('student') . ' ' . translate('daily_reports') ?>
                                                            </a>
                                                        </li>
                                                        <li class="<?php if ($sub_page == 'attendance/studentwise_overview')
                                                            echo 'nav-active'; ?>">
                                                    ...
                                                    <?php }
                                                    if ($getAttendanceType == 2 || $getAttendanceType == 1) { ?>
                                                        <li class="<?php if ($sub_page == 'attendance_period/reports')
                                                            echo 'nav-active'; ?>">
                                                            <a href="<?= base_url('attendance_period/reports') ?>">
                                                                <?= translate('subject_wise_reports') ?>
                                                            </a>
                                                        </li>
                                                        <li class="<?php if ($sub_page == 'attendance_period/reportsbydate')
                                                            echo 'nav-active'; ?>">
                                                            <a href="<?= base_url('attendance_period/reportsbydate') ?>">
                                                                <?= translate('subject_wise_by') . ' ' . translate('day') ?>
                                                            </a>
                                                        </li>
                                                        <li class="<?php if ($sub_page == 'attendance_period/reportbymonth')
                                                            echo 'nav-active'; ?>">
                                    ...
                                    <li class="nav-parent <?php if ($main_menu == 'exam_reports')
                                        ...
                                        <ul class="nav nav-children">
                                            ...
                                            if (get_permission('progress_reports', 'is_view')) { ?>
                                                <li class="<?php if ($sub_page == 'exam_progress/marksheet')
                                                    echo 'nav-active'; ?>">
                    ...
                    <?php if (moduleIsEnabled('alumni')) {
                        if (
                            get_permission('manage_alumni', 'is_view') ||
                            ...
                            <li class="nav-parent <?php if ($main_menu == 'alumni')
                                ...
                                <ul class="nav nav-children">
                                    <?php if (get_permission('manage_alumni', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'alumni/index')
                                            echo 'nav-active'; ?>">
                                            <a href="<?php echo base_url('alumni/index'); ?>">
                                                <span><i class="fas fa-caret-right"
                                                        aria-hidden="true"></i><?php echo translate('manage_alumni'); ?></span>
                                            </a>
                                        </li>
                                    <?php }
                                    if (get_permission('alumni_events', 'is_view')) { ?>
                                        <li class="<?php if ($sub_page == 'alumni/events')
                                            echo 'nav-active'; ?>">
                                            <a href="<?php echo base_url('alumni/event'); ?>">
                                                <span><i class="fas fa-caret-right"
                                                        aria-hidden="true"></i><?php echo translate('events'); ?></span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                </ul>
                    ...
                    if (
                        ...
                        <li class="nav-parent <?php if ($main_menu == 'settings' || $main_menu == 'school_m')
                            ...
                            <ul class="nav nav-children">
                                ...
                                <?php }
                                if (is_superadmin_loggedin()) { ?>
                                    <li class="<?php if ($sub_page == 'modules/index')
                                        echo 'nav-active'; ?>">
                                ...
                                if (get_permission('system_student_field', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'system_student_field/index')
                                        echo 'nav-active'; ?>">
                                ...
                                if (get_permission('system_update', 'is_add')) { ?>
                                    <li class="<?php if ($sub_page == 'system_update/index')
                                        echo 'nav-active'; ?>">
                                ...
                                if (get_permission('user_login_log', 'is_view')) { ?>
                                    <li class="<?php if ($sub_page == 'user_login_log/index')
                                        echo 'nav-active'; ?>">
                                        <a href="<?= base_url('user_login_log/index') ?>">
                                            <span><i class="fas fa-caret-right"
                                                    aria-hidden="true"></i><?= translate('user_login_log') ?></span>
                                        </a>
                                    </li>
                                <?php } ?>
