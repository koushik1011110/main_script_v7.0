<header class="header">
	<style>
		/* Remove the pseudo-element box behind all navbar icons */
		...
		html.header-dark .header-menu .header-menu-icon:before {
	...
	<div class="logo-env">
		...
		<div class="visible-xs toggle-sidebar-left header-menu-icon" data-toggle-class="sidebar-left-opened" data-target="html" data-fire-event="sidebar-left-opened">
				...
				<div class="dropdown-menu header-menubox qk-menu">
					<div class="qk-menu-p">
						...
						<?php if(get_permission('student', 'is_add')){ ?>
							<a href="<?php echo base_url('student/add');?>"><i class="fas fa-user-plus"></i> <?php echo translate('student_admission');?></a>
						<?php } if(get_permission('salary_payment', 'is_add')) { ?>
							<a href="<?php echo base_url('payroll'); ?>"><i class="fas fa-money-bill-wave"></i> <?php echo translate('salary_payment');?></a>
						<?php } if(get_permission('leave_manage', 'is_view')) { ?>
							<a href="<?php echo base_url('leave');?>"><i class="fas fa-umbrella-beach"></i> <?php echo translate('leave_application');?></a>
						...
						<?php } if(get_permission('due_invoice', 'is_view')) { ?>
							<a href="<?php echo base_url('fees/due_invoice');?>"><i class="fas fa-file-invoice"></i> <?php echo translate('due_fees_invoice');?></a>
						<?php } if(get_permission('invoice', 'is_view')) { ?>
							<a href="<?php echo base_url('fees/invoice_list');?>"><i class="fas fa-receipt"></i> <?php echo translate('payments_history');?></a>
						<?php } ?>
						</div>
					</div>
				</div>
			...
			<?php echo form_open('student/search', array('class' => 'search nav-form'));?>
				<div class="input-group input-search">
					...
					<span class="input-group-btn">
						<button class="btn btn-default" type="submit"><i class="fas fa-magnifying-glass"></i></button>
					</span>
				</div>
			</form>
		<?php endif;?>
			...
			<li>
				...
				<div class="dropdown-menu header-menubox mh-oh">
					<div class="notification-title">
						<i class="fas fa-retweet"></i> <?php echo translate('switch_class');?>
					</div>
...
if (!empty($get_session)) {
	?>
			...
			<li>
				...
				<div class="dropdown-menu header-menubox mh-oh">
					<div class="notification-title">
						<i class="far fa-calendar-days"></i> <?php echo translate('academic_session');?>
					</div>
...
<?php } ?>
			...
			<li>
				...
				<div class="dropdown-menu header-menubox mh-oh">
					<div class="notification-title">
						<i class="fas fa-language"></i> <?php echo translate('language');?>
					</div>
					<div class="content hbox lb-pr">
						<div class="scrollable visible-slider dh-tf" data-plugin-scrollable>
							<div class="scrollable-content">
		...
		<div id="userbox" class="userbox">
			...
			<div class="dropdown-menu">
				<ul class="dropdown-user list-unstyled">
					...
					<li><a href="<?php echo base_url('profile');?>"><i class="fas fa-user-gear"></i> <?php echo translate('profile');?></a></li>
					...
					<?php if(get_permission('global_settings', 'is_view')):?>
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo base_url('settings/universal');?>"><i class="fas fa-sliders"></i> <?php echo translate('global_settings');?></a></li>
					<?php endif; ?>
