		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#cashfree" data-toggle="tab">Cashfree</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div class="tab-pane box" id="cashfree">
						<?php echo form_open('saas/savePaymentConfig', array('class' => 'form-horizontal frm-submit-msg'));?>
							<input type="hidden" name="sandbox" value="cashfree_sandbox">
							<div class="form-group">
								<label  class="col-sm-3 control-label">Cashfree App ID</label>
								<div class="col-md-6 mb-md">
									<input type="text" class="form-control" name="cashfree_app_id" value="<?=$config['cashfree_app_id']?>" autocomplete="off">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-3 control-label">Cashfree Secret Key</label>
								<div class="col-md-6 mb-md">
									<input type="text" class="form-control" name="cashfree_secret_key" value="<?=$config['cashfree_secret_key']?>" autocomplete="off">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-offset-3 col-md-6 mb-md">
									<div class="checkbox-replace">
										<label class="i-checks">
											<input type="checkbox" name="cashfree_sandbox" id="cashfree_sandbox" <?=($config['cashfree_sandbox'] == 1 ? 'checked' : ''); ?>>
											<i></i> Cashfree Sandbox
										</label>
									</div>
								</div>
							</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="checkbox-replace">
							<label class="i-checks">
								<input type="checkbox" name="payhere_status" id="payhere_status" <?=($config['payhere_status'] == 1 ? 'checked' : ''); ?>>
								<i></i> Payhere
							</label>
						</div>
					</div>
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="checkbox-replace">
							<label class="i-checks">
								<input type="checkbox" name="cashfree_status" id="cashfree_status" <?=($config['cashfree_status'] == 1 ? 'checked' : ''); ?>>
								<i></i> Cashfree
							</label>
						</div>
					</div>
