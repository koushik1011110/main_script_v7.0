...
<body>
    ...
    <!-- Start Header Area -->
    <header class="header navbar-area glass-header">
        <div class="container-md">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="nav-inner glass-nav">
                        <!-- Start Navbar -->
                        <nav class="navbar navbar-expand-lg">
                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a href="#home" class="page-scroll active"
                                            aria-label="Toggle navigation"><?php echo translate('home'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#features" class="page-scroll"
                                            aria-label="Toggle navigation"><?php echo translate('features'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#pricing" class="page-scroll"
                                            aria-label="Toggle navigation"><?php echo translate('pricing'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#faq" class="page-scroll"
                                            aria-label="Toggle navigation"><?php echo translate('faq'); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#contact" class="page-scroll"
                                            aria-label="Toggle navigation"><?php echo translate('contact'); ?></a>
                                    </li>
                                </ul>
                            </div>
                            <!-- navbar collapse -->
                            <div class="header-btn">
                                <div class="button add-list-button">
                                    <?php if (!is_loggedin()) { ?>
                                        <a href="https://schools.sssassam.com/authentication/index"
                                            class="btn"><?php echo translate('login'); ?></a>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url('dashboard/index') ?>"
                                            class="btn"><?php echo translate('dashboard'); ?></a>
                                    <?php } ?>
                                </div>
    ...
    <!-- Start Slider Area -->
    <section id="home" class="hero-area modern-hero">
        <div class="modern-hero-bg"
            style="background-image: url(<?php echo base_url('assets/frontend/images/saas/' . $getSettings->slider_bg_image) ?>);">
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="hero-content">
                        ...
                        <p class="wow fadeInLeft" data-wow-delay=".6s"><?php echo $getSettings->slider_description; ?>
                        </p>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="hero-image wow fadeInRight floating-anim" data-wow-delay=".4s">
                        <img src="<?php echo base_url('assets/frontend/images/saas/' . $getSettings->slider_image) ?>"
                            alt="#">
                        <?php if ($getSettings->overly_image_status == 1) { ?>
                            <img class="overly"
                                src="<?php echo base_url('assets/frontend/images/saas/' . $getSettings->overly_image) ?>"
                                alt="#">
                        <?php } ?>
                    </div>
                </div>
    ...
    <!-- Start Features Area -->
    <section id="features" class="features section glass-section relative-z">
        <div class="features-gradient-bg"></div>
        <div class="container relative-z">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s"><?php echo $getSettings->feature_description; ?>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                foreach ($featureslist as $key => $feature) {
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-feature glass-card wow fadeInUp" data-wow-delay="<?php echo $delaycount ?>s">
    ...
    <section id="pricing" class="pricing-table section modern-pricing">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s"><?php echo $getSettings->price_plan_description; ?>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                foreach ($getPackageList as $key => $value) {
                    ?>
                    <div class="col-md-6 col-xl-4 col-xxl-3 pp-plans-container wow fadeInUp"
                        data-wow-delay="<?php echo $delaycount ?>s">
                        <div
                            class="pp-plans glass-card modern-plan-card <?php echo $value->recommended == 1 ? ' pxp-is-featured vibrant-border' : '' ?>">
                            <div class="pp-plans-top">
                                <?php if ($value->recommended == 1) { ?>
                                    <div class="pp-plans-featured-label vibrant-label">Recommended</div>
                                <?php } ?>
                                ...
                                <div class="pp-plans-price">
                                    <div class="pxp-plans-price-monthly">
                                        ...
                                        <?php if ($value->discount == 0) { ?>
                                            ₹<?php echo number_format($value->price, 1, '.', '') ?><span>/
                                                <?php echo ($value->period_value == 0 ? '' : $value->period_value) . " " . $getPeriodType[$value->period_type] ?></span>
                                        <?php } else { ?>
                                            <div class="discount">
                                                ₹<?php echo number_format($value->price, 1, '.', '') ?>
                                            </div>
                                            ₹<?php echo number_format(($value->price - $value->discount), 1, '.', ''); ?><span>/
                                                <?php echo ($value->period_value == 0 ? '' : $value->period_value) . " " . $getPeriodType[$value->period_type] ?>
                                            </span>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="pp-plans-list">
                                    <ul class="list-unstyled pricing-feature-list">
                                        <li><i class="lni lni-user"></i>Student Limit : <?php echo $value->student_limit ?>
                                        </li>
                                        <li><i class="lni lni-user"></i>Parents Limit : <?php echo $value->parents_limit ?>
                                        </li>
                                        <li><i class="lni lni-user"></i>Staff Limit : <?php echo $value->staff_limit ?></li>
                                        <li><i class="lni lni-user"></i>Teacher Limit : <?php echo $value->teacher_limit ?>
                                        </li>
                                        <?php
                                        ...
                                        foreach ($modules as $key => $value2) {
                                            ?>
                                            <li><i
                                                    class="<?php echo (in_array($value2->id, $permissions) ? 'lni lni-checkmark' : 'lni lni-close'); ?>"></i>
                                                <?php echo $value2->name ?></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </div>
                            <div class="pp-plans-bottom">
                                <div class="pp-plans-cta button">
                                    <?php if (is_admin_loggedin()) {
                                        ?>
                                        <a class="btn btn-vibrant plans-purchase"
                                            href="<?php echo base_url('subscription/renew?id=' . $value->id) ?>">
                                            <?php echo translate('renew'); ?></a>
                                    <?php } else { ?>
                                        <button class="btn btn-vibrant plans-purchase" data-id="<?php echo $value->id ?>"
                                            data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing">
                                            <?php echo $getSettings->price_plan_button; ?></button>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading<?php echo $key ?>">
                                    <button class="accordion-button collapsed" type=button data-bs-toggle=collapse
                                        data-bs-target="#faq<?php echo $key ?>"
                                        aria-expanded="<?php echo $key == 0 ? 'true' : ''; ?>" aria-controls=collapseOne>
                                        <span class=title><span
                                                class="serial"><?php echo $count++; ?></span><?php echo $faq->title; ?></span><i
                                            class="lni lni-plus"></i>
                                    </button>
                                </h2>
                                <div id="faq<?php echo $key ?>" class="accordion-collapse collapse"
                                    aria-labelledby="heading<?php echo $key ?>" data-bs-parent="#accordionExample">
                    ...
                    <div class="contact-form">
                        ...
                        <?php if ($this->session->flashdata('msg_success')): ?>
                            <div class="alert alert-success">
                                <i class="icon-text-ml far fa-check-circle"></i>
                        ...
                        <div class="form-group wow fadeInUp" data-wow-delay=".6s">
                            <textarea type="text" rows="5" class="form-control alert_settings"
                        ...
                        <div class="button wow fadeInUp" data-wow-delay=".8s">
                            <button class="btn btn-alt" type="submit"
                                data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing"><i
                                    class="fas fa-envelope"></i> <?php echo $getSettings->contact_button; ?></button>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 col-12">
                    <h2 class="contact-title wow fadeInUp" data-wow-delay=".2s">
                        <?php echo $getSettings->contact_description; ?>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="single-footer f-link">
                                    <h3>Quick Link</h3>
                                    <ul>
                                        <li><a href="#home" class="page-scroll active" aria-label="Toggle navigation"><i
                                                    class="fas fa-angle-right"></i> <?php echo translate('home'); ?></a>
                                        </li>
                                        <li><a href="#features" class="page-scroll" aria-label="Toggle navigation"><i
                                                    class="fas fa-angle-right"></i>
                                                <?php echo translate('features'); ?></a></li>
                                        <li><a href="#pricing" class="page-scroll" aria-label="Toggle navigation"><i
                                                    class="fas fa-angle-right"></i>
                                                <?php echo translate('pricing'); ?></a></li>
                                        <li><a href="#faq" class="page-scroll" aria-label="Toggle navigation"><i
                                                    class="fas fa-angle-right"></i> <?php echo translate('faq'); ?></a>
                                        </li>
                                        <li><a href="#contact" class="page-scroll" aria-label="Toggle navigation"><i
                                                    class="fas fa-angle-right"></i>
                                                <?php echo translate('contact'); ?></a></li>
                                        <?php if ($getSettings->terms_status == 1) { ?>
                                            <a href="javascript:void(0)" id="termsFooter"><i class="fas fa-angle-right"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="single-footer f-link address">
                                    <h3>Address</h3>
                                    <ul>
                                        <li class="clearfix"><i class="lni lni-map-marker"></i>
                                            <div style="margin-left: 47px;"><?php echo $global_config['address'] ?>
                                            </div>
                                        </li>
                                        <li class="clearfix"><i class="lni lni-phone"></i>
                                            <?php echo $global_config['mobileno'] ?></li>
                                        <li class="clearfix"><i class="lni lni-envelope"></i>
                                            <?php echo $global_config['institute_email'] ?></li>
                                    </ul>
                                </div>
                                <!-- End Single Widget -->
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="single-footer f-link">
                                    <h3>Social Link</h3>
                                    <ul class="social">
                                        <li><a href="<?php echo $global_config['facebook_url'] ?>"><i
                                                    class="lni lni-facebook-filled"></i></a></li>
                                        <li><a href="<?php echo $global_config['twitter_url'] ?>"><i
                                                    class="lni lni-twitter-original"></i></a></li>
                                        <li><a href="<?php echo $global_config['instagram_url'] ?>"><i
                                                    class="lni lni-instagram"></i></a></li>
                                        <li><a href="<?php echo $global_config['linkedin_url'] ?>"><i
                                                    class="lni lni-linkedin-original"></i></a></li>
                                        <li><a href="<?php echo $global_config['youtube_url'] ?>"><i
                                                    class="lni lni-youtube"></i></a></li>
                                        <li><a href="<?php echo $global_config['google_plus_url'] ?>"><i
            ...
            <div class="footer-copyright">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="payment-logo">
                        <img src="<?php echo base_url('assets/frontend/images/saas/' . $getSettings->payment_logo); ?>"
                            alt="">
                    </div>
                </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="regModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php if ($getSettings->terms_status == 1) { ?>
                            <div class="form-group">
                                <div class="checkbox-replace">
                                    <label class="i-checks"><input type="checkbox" name="terms_cb"><i></i>
                                        <?php echo $getSettings->agree_checkbox_text ?></label>
                                </div>
                                <span class="error"></span>
                            </div>
                        <?php } ?>
                        ...
                        <div class="pp-plans-bottom">
                            <div class="pp-plans-cta button">
                                <button class="btn mb-4" data-id="1" type="submit"
                                    data-loading-text="<i class='fas fa-spinner fa-spin'></i> Processing"> Register &
                                    Payment</button>
                            </div>
                        </div>
                    </div>
