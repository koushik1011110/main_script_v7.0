			...
			<div class="tabs-custom">
				...
				<div class="tab-content">
					...
					<div class="tab-pane box" id="cashfree">
						<?php echo form_open('settings/cashfree_save', array('class' => 'form-horizontal frm-submit-msg'));?>
							<input type="hidden" name="branch_id" value="<?=$branch_id?>">
							<div class="form-group">
							  <label  class="col-sm-3 control-label">Cashfree App ID</label>
								<div class="col-md-6">
									<input type="text" class="form-control" autocomplete="off" name="cashfree_app_id" value="<?=$config['cashfree_app_id']?>">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6 mb-md">
									<input type="text" class="form-control" autocomplete="off" name="cashfree_secret_key" value="<?=$config['cashfree_secret_key']?>">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
